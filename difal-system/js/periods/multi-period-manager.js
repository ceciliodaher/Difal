/**
 * @fileoverview Multi Period Manager - Gerenciamento de múltiplos períodos SPED
 * @module MultiPeriodManager
 * @description Responsável por gerenciar múltiplos arquivos SPED da mesma empresa,
 * validando períodos distintos e CNPJ consistente para modo multi-period.
 * 
...
class MultiPeriodManager {
    ...
    constructor(stateManager, eventBus) {
        ...
        this.mode = 'multi'; // Identificador do modo
        ...
        console.log('📅 MultiPeriodManager inicializado');
    }
