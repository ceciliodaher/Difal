...
module.exports = defineConfig({
    testDir: '.',
    testMatch: ['test-final-functionality.js', 'test-mode-selection.js', 'test-freeze-diagnostic.js', 'test-initialization-errors.js', 'test-complete-system.js', 'test-upload-fix.js', 'test-quick-diagnostic.js', 'test-singleton-initialization.js', 'test-complete-single-workflow.js', 'multi-period-analysis.spec.js', 'test-multi-period-workflows.spec.js'],
